...
ldamodel = Lda('Mallet/bin/mallet', corpus=doc_term_matrix, num_topics=100, id2word = dictionary, optimize_interval=10, iterations=5000, alpha=0.005)
temp_file = "model_10k_5000_alpha_5e-2"
